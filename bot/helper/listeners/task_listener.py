 ...
 """,
    ...
    async def on_upload_complete(
        ...
        if self.is_yt:
            ...
            if self.bot_pm:
                pmsg = msg
                pmsg += "〶 <b><u>Files sent to User PM :</u></b>\n"
                if self.is_super_chat:
                    buttons = ButtonMaker()
                    buttons.url_button("🔗 View Files", f"http://t.me/{TgClient.BNAME}", 'header')
                    buttons.url_button("🔄 Update", f"https://t.me/HearTxBots")
                    buttons.url_button("💬 Support", f"https://t.me/HearTxBots")
                    await send_message(self.message, pmsg, buttons.build_menu(2))
